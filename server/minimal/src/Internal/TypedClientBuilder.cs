...
// https://github.com/dotnet/aspnetcore/blob/main/src/SignalR/server/Core/src/Internal/TypedClientBuilder.cs
...
{
    private const string ClientModuleName = "EasyR.TypedClientBuilder";
