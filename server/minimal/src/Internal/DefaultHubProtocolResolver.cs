...
// https://github.com/dotnet/aspnetcore/blob/main/src/SignalR/server/Core/src/Internal/DefaultHubProtocolResolver.cs
...
internal sealed partial class DefaultHubProtocolResolver : IHubProtocolResolver
{
    ...
    {
        [LoggerMessage(1, LogLevel.Debug, "Registered EasyR Protocol: {ProtocolName}, implemented by {ImplementationType}.", EventName = "RegisteredEasyRProtocol")]
