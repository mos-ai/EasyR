...
// https://github.com/dotnet/aspnetcore/blob/main/src/SignalR/clients/csharp/Client.Core/src/HubConnectionBuilderExtensions.cs

using Bedrock.Framework;

using EasyR.Client.Internal;
...
public static class HubConnectionBuilderExtensions
{
    ...
    public static IHubConnectionBuilder WithNamedPipe(this IHubConnectionBuilder hubConnectionBuilder, EndPoint endPoint)
    {
        if (endPoint is not NamedPipeEndPoint)
        {
    ...
    // TBD: Review and test each function.
