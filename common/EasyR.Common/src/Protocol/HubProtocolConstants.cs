...
// https://github.com/dotnet/aspnetcore/blob/main/src/SignalR/common/SignalR.Common/src/Protocol/HubProtocolConstants.cs

namespace EasyR.Protocol;

/// <summary>
/// Constants related to the EasyR hub protocol.
/// </summary>
